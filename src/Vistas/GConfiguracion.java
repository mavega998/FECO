...
public class GConfiguracion extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Marca", "Modelo", "Estado", "Salida Digital", "Entrada Digital", "Salida Analogo", "Entrada Analogo"
            }
        ) {
        ...
        jLabel12.setText("Numero Salidas Digitales:");

        jLabel13.setText("Numero Entradas Digitales");

        jLabel14.setText("Numero Salidas Analogas:");

        jLabel15.setText("Numero Entradas Analogas");

        jLabel33.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/placa1.png"))); // NOI18N
        ...
        jTabbedPane1.addTab("MODULO", jPanel2);
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Usuario", "Nombre", "Contraseña", "Email", "Telefono", "Direccion", "Rol", "Estado"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Administrador", "Agronomo", "Agricultor" }));
        ...
        jTabbedPane1.addTab("LOTE", jPanel5);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Dias", "SP Ph", "SP Hum Amb", "SP Hum Piso", "SP Temp Amb", "SP Temp Piso"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jLabel4.setText("SP Ph:");

        jLabel5.setText("SP Humedad Ambiente:");

        jLabel6.setText("SP Humedad Piso:");

        jLabel7.setText("SP Temperatura Ambiente:");

        jTextField5.setText(" ");

        jLabel8.setText("SP Temperatura Piso:");
        ...
        jLabel24.setText("SP Ph:");

        jLabel25.setText("SP Humedad Ambiente:");

        jTextField21.setText(" ");

        jTextField22.setText(" ");

        jLabel26.setText("SP Humedad Piso:");

        jLabel27.setText("SP Temperatura Ambiente:");

        jTextField23.setText(" ");

        jTextField24.setText(" ");

        jLabel28.setText("SP Temperatura Piso:");

        jLabel3.setText("INICIACIÓN");

        jLabel31.setText("MADURACIÓN");
        ...
        jTabbedPane1.addTab("CULTIVO", jPanel1);
...
//        }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(GConfiguracion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    }
